...
6. Evaluate residual policies: `uv run src/eval_residual.py --run-path ./logs-residual/<wandb-run-name> --config.base-policy-path ./logs-bc/<wandb-run-name>/<epoch-number>/policies/ --output-dir <output-dir>`
