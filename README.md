...
4. Train residual policies: `uv run src/train_residual.py --config.run-path ./logs-bc/<wandb-run-name> --config.base-policy-path ./logs-bc/<wandb-run-name>/<epoch-number>/policies/`
